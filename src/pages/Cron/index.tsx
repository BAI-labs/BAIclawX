        ...
        <CardContent className="space-y-6 pt-4 overflow-y-auto flex-1 p-6">
          ...
          <div className="space-y-2.5">
            ...
            <Input
              ...
              className="h-[44px] rounded-xl font-mono text-[13px] bg-secondary border-black/10 dark:border-white/10 focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:border-primary shadow-sm transition-all text-foreground placeholder:text-foreground/40"
            />
          </div>
          ...
          <div className="space-y-2.5">
            ...
            <Textarea
              ...
              rows={3}
              className="rounded-xl font-mono text-[13px] bg-secondary border-black/10 dark:border-white/10 focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:border-primary shadow-sm transition-all text-foreground placeholder:text-foreground/40 resize-none"
            />
          </div>
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      schedule === preset.value
                        ...
                        : "bg-secondary border-black/10 dark:border-white/10 hover:bg-black/5 dark:hover:bg-white/5 text-foreground/80 hover:text-foreground"
                    )}
                  >
          ...
          {/* Enabled */}
          <div className="flex items-center justify-between bg-secondary p-4 rounded-2xl shadow-sm border border-black/5 dark:border-white/5">
            <div>
