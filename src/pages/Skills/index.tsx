          ...
          <div className="space-y-7 px-1">
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  readOnly
                  className="h-[38px] font-mono text-[12px] bg-secondary border-black/10 dark:border-white/10 rounded-xl text-foreground/70"
                />
                <Button
                  variant="outline"
                  size="icon"
            ...
            {canEditSkillConfig && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="password"
                  className="h-[44px] font-mono text-[13px] bg-secondary border-black/10 dark:border-white/10 rounded-xl focus-visible:ring-2 focus-visible:ring-blue-500/50 focus-visible:border-blue-500 shadow-sm transition-all text-foreground placeholder:text-foreground/40"
                />
            ...
            {canEditSkillConfig && (
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  {envVars.length === 0 && (
                    <div className="text-[13px] text-foreground/50 font-medium italic flex items-center bg-secondary border border-black/5 dark:border-white/5 rounded-xl px-4 py-3 shadow-sm">
                  ...
                  {envVars.map((env, index) => (
                    <div className="flex items-center gap-3" key={index}>
                      <Input
                        ...
                        className="flex-1 h-[40px] font-mono text-[13px] bg-secondary border-black/10 dark:border-white/10 rounded-xl focus-visible:ring-2 focus-visible:ring-blue-500/50 shadow-sm text-foreground"
